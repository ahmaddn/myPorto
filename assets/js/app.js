      ...
      <div class="group bg-ink2 rounded-2xl border border-white/5 overflow-hidden hover:border-cyan/30 transition-all duration-300 hover:shadow-glow-cyan" data-aos="fade-up">
        <div class="p-6">
          ...
          <div class="flex gap-2">
            ...
            <a href="${p.github}" class="text-xs bg-ink3 text-muted px-3 py-1.5 rounded-lg hover:bg-ink4 transition-all flex items-center gap-1.5"><i data-lucide="github" class="w-3 h-3"></i> Code</a>
          </div>
        </div>
      </div>`,
        )
